...
async def ping_pong(client, message):
    await message.reply_text('I Am Sure That You Are Super Jealous Because of My Beautiful Hair👀, And You Should Be. \nAnd Stop Poking Me Again And Again For No reason.')
